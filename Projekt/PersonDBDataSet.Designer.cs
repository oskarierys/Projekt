...
namespace Projekt {
    ...
    public partial class PersonDBDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(int Id, string Name, string Surname, int Age, string Gender) {
...
namespace Projekt.PersonDBDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Person] WHERE (([Id] = @Original_Id) AND ([Name] = @Original_N" +
                "ame) AND ([Surname] = @Original_Surname) AND ([Age] = @Original_Age) AND ([Gende" +
                "r] = @Original_Gender))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Id], [Name], [Surname], [Age], [Gender]) VALUES (@Id" +
                ", @Name, @Surname, @Age, @Gender);\r\nSELECT Id, Name, Surname, Age, Gender FROM P" +
                "erson WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [Id] = @Id, [Name] = @Name, [Surname] = @Surname, [Age] = @Age, [Gender] = @Gender WHERE (([Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Surname] = @Original_Surname) AND ([Age] = @Original_Age) AND ([Gender] = @Original_Gender));
SELECT Id, Name, Surname, Age, Gender FROM Person WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Projekt.Properties.Settings.Default.PersonDBConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Surname, Age, Gender FROM dbo.Person";
        ...
        public virtual int Delete(int Original_Id, string Original_Name, string Original_Surname, int Original_Age, string Original_Gender) {
        ...
        public virtual int Insert(int Id, string Name, string Surname, int Age, string Gender) {
        ...
        public virtual int Update(int Id, string Name, string Surname, int Age, string Gender, int Original_Id, string Original_Name, string Original_Surname, int Original_Age, string Original_Gender) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, int Age, string Gender, int Original_Id, string Original_Name, string Original_Surname, int Original_Age, string Original_Gender) {
            return this.Update(Original_Id, Name, Surname, Age, Gender, Original_Id, Original_Name, Original_Surname, Original_Age, Original_Gender);
        }
    }
